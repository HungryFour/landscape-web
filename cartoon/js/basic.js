...
if (function (e, t) {
  ...
  var ue = function (e) {
    ...
    }, b.sortStable = R.split("").sort(U).join("") === R, b.detectDuplicates = !!S, I(), b.sortDetached = r(function (e) {
  ...
  re.extend({
    ...
    css: function (e, t, n, i) {
      var r, o, s, a = re.camelCase(t);
      return t = re.cssProps[a] || (re.cssProps[a] = S(a) || a), s = re.cssHooks[t] || re.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = A(e, t, i)), "normal" === r && t in Ze && (r = Ze[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
    }
  ...
  re.ajaxSetup({
    ...
    var r, o, s,
      a = !1 !== t.jsonp && (Pt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Pt.test(t.data) && "data");
    ...
    G = function (e) {
      ...
      return m(t, e), x(t, [{
        ...
        value: function (e, t) {
          ...
          var i = ["left", "top", "bottom", "right", "middle", "center"]; /*#文件名称:basic.js #米拓企业建站系统 #Copyright (C) 长沙米拓信息技术有限公司 (http://www.metinfo.cn). All rights reserved.*/
...
+function (e) {
  ...
  }, h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + S.join(" "), d
}(this, this.document),
  function (e, t, n) {
    function i(e) {
  ...
  videoSizeRes: function () {
    $(this).each(function () {
      var e = $(this),
        ...
        n = $(this).width();
      n < 10 && (t = .5625, $(this).width($(this).parent().width()), n = $(this).width()), t && (setTimeout(function () {
        e.height(e.width() * t)
